...
class MotorRecomendacion:
    ...
    def generar_para_usuario(
        ...
        menu = models.MenuDiario(
            ...
            mensaje           = self._generar_mensaje(perfil, contexto),
    ...
    def _seleccionar_comida(
        ...
        # Puntuar candidatos según contexto y objetivo
    ...
    def _generar_mensaje(self, perfil: models.PerfilNutricional, contexto: dict) -> str:
        tipo_dia = contexto.get("tipo_dia", "normal")
